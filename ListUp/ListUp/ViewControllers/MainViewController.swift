...
extension MainViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            guard let mainBanerCell: MainBanerCell = tableView.dequeueReusableCell(withIdentifier: "MainBanerCell", for: indexPath) as? MainBanerCell else {return UITableViewCell()}
        ...
        case 1:
            ...
            return sectionCell
        case 2:
            guard let shoppingmallListCell: ShoppingmallListCell = tableView.dequeueReusableCell(withIdentifier: "ShoppingmallListCell", for: indexPath) as? ShoppingmallListCell else {return UITableViewCell()}
        ...
        case 3:
            ...
            return sectionCell
        case 4:
            guard let recommendCell: RecommendCell = tableView.dequeueReusableCell(withIdentifier: "RecommendCell", for: indexPath) as? RecommendCell else {return UITableViewCell()}
